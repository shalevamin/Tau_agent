...
enum UIStrings {
    static let welcomeTitle = "Welcome to Tua Agent"
}
...
struct OnboardingView: View {
    ...
    @State var ultimateSetupRunning = false
    @State var ultimateSetupStatus: String?
    @State var ultimateSetupDetail: String?
    @State var browserExtensionPath: String?
