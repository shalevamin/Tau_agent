...
final class MacNodeModeCoordinator {
    ...
    private func currentCommands(caps: [String]) -> [String] {
        var commands: [String] = [
            ...
            OpenClawSystemCommand.screenshot.rawValue,
            OpenClawSystemCommand.mouse.rawValue,
            OpenClawSystemCommand.type.rawValue,
            OpenClawSystemCommand.keypress.rawValue,
